      ...
      return (
        <ul className="[&>li]:my-2 [&>li]:pl-0">
          ...
          <li>
            ...
            <strong>Electronics and Telecommunications</strong>, but I
            couldn&apos;t find interest in that field. So I learned Software
            Engineering instead, and became what I am today.
          </li>
        </ul>
      );
    },
