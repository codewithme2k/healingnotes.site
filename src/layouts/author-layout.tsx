        ...
        <div className="md:col-span-2 md:pl-12 xl:pl-16">
          <div className="prose prose-lg dark:prose-invert">
            <div>
              ...
              <p>
                I&apos;m <strong>Tuan Anh Huynh</strong> (alias{" "}
                <strong>Leo</strong> at work), a software engineer from{" "}
                <strong>Vietnam</strong>. I have a passion for all things{" "}
                <strong>Javascript</strong>. I enjoy building eCommerce software
                and stuff related to web dev. I work mainly with{" "}
